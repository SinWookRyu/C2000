...
namespace MaterialSkin.Controls
{
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        private const int ACTION_BAR_HEIGHT = 32;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //Form title
            g.DrawString(Text, SkinManager.ROBOTO_MEDIUM_11, SkinManager.ColorScheme.LightPrimaryBrush, new Rectangle(20, 0, Width, STATUS_BAR_HEIGHT), new StringFormat { LineAlignment = StringAlignment.Center });
        }
    }
